...
const WA_E = () => {
  return (
    <div className="flex flex-col fixed bottom-2 right-5 z-50 ">
      <a
        href="tel:+919886009778" // tel: protocol for phone call
        aria-label="Call us"
        className="flex items-center justify-center rounded-full mb-3"
      >
        <img src={PhoneIcon} alt="phone logo" className="w-10 h-10" />
        {/* Use phone icon */}
      </a>
      <a
      ...
      >
        <img src={WhatsAppIcon} alt="whatsapp logo" className="w-10 h-10" />
      </a>
      ...
      >
        <img src={EmailIcon} alt="email logo" className="w-10 h-10" />
      </a>
    </div>
  );
};
